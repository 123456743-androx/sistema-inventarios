...
// PAGINA PRINCIPAL (LOGIN CON EJS)
app.get("/", (req, res) => {
    res.render("login");
});

// ACCESO POR URL DIRECTA /LOGIN
...
// REGISTRO PAGINA (Sigue apuntando a HTML mientras lo cambies)
...
app.get("/inicio", (req, res) => {
    // Si tienes un archivo inicio.html o inicio.ejs, lo apuntas aquí. 
    // Por ahora, redirigimos a /productos para que no de error:
...
app.get('/productos', async(req, res) => {
    ...
    productos.forEach(producto => {
        ...
        <td>
        <a href="/editar/${producto._id}">Editar</a>
        <a href="/eliminar/${producto._id}">Eliminar</a>
        </td>
        </tr>
        `;
    });
...
app.get('/editar/:id', async(req, res) => {
    ...
    <input name="precio" value="${producto.precio}" type="number" step="0.01">
...
// PANTALLAS INVENTARIO (Siguen apuntando a HTML por ahora)
app.get("/entradas", (req, res) => {
    res.sendFile(path.join(__dirname, "views/entradas.html"));
});
